...
export default function CalcularConsumo2() {
    ...
    const redirectToEmail = async () => {
        try {
            await AsyncStorage.setItem('lavadoraHoras', num);
            navigation.navigate('CalcularConsumo3')
        } catch (e) {
    ...
    return (
        <View style={styles.contenedor}>
            <View style={styles.contenedorQuestion}>
                <Text style={styles.textQuestionName}>¿Cuantas horas al dia usas la lavadora?</Text>
