...
export default function CalcularConsumo4() {
    ...
    const redirectToEmail = async () => {
        try {
            await AsyncStorage.setItem('computadoraHoras', num);
            navigation.navigate('CalcularConsumo5')
        } catch (e) {
    ...
    return (
        <View style={styles.contenedor}>
            <View style={styles.contenedorQuestion}>
                <Text style={styles.textQuestionName}>¿Cuantas horas al dia usas la computadora portatil o de escritorio?</Text>
